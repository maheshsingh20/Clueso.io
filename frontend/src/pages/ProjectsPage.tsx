        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-md border border-gray-200/50 p-8 mb-8 shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
          <div className="relative z-10">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-sm font-bold uppercase tracking-wider text-red-700 bg-red-50/60 px-3 py-1 rounded-md">All Projects</span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-semibold rounded-md shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="lg:w-64">
              <div className="relative">
                ...
                <select
                  className="w-full pl-12 pr-6 py-4 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-transparent shadow-lg transition-all duration-300"
              ...
              {projects?.data?.map((project, index) => {
                ...
                return (
                  <Link
                    ...
                    className={`group relative overflow-hidden rounded-md border border-gray-200/60 ${bgColor} backdrop-blur-sm hover:shadow-2xl ${hoverColor} hover:-translate-y-2 hover:scale-[1.02] transition-all duration-300`}
                  >
                    ...
                    <div className="relative z-10 p-6">
                      ...
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex items-start space-x-4">
                          <div className={`w-14 h-14 bg-gradient-to-br ${iconColor} rounded-md flex items-center justify-center shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 flex-shrink-0`}>
                        ...
                        <button className="text-gray-400 hover:text-gray-600 p-2 rounded-md hover:bg-white/80 transition-all duration-200 flex-shrink-0">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center space-x-4">
                          <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-md px-4 py-2 shadow-sm">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center text-gray-700 group-hover:text-gray-900 transition-colors bg-white/80 backdrop-blur-sm rounded-md px-4 py-2 shadow-sm">
            ...
            <div className="mt-12 flex items-center justify-between bg-white/80 backdrop-blur-sm rounded-md border border-gray-200/50 p-6 shadow-lg">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="px-4 py-2 border-2 border-gray-300/80 rounded-md text-sm font-semibold text-gray-700 hover:bg-white hover:border-cyan-400 hover:text-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 bg-white/60 backdrop-blur-sm"
                >
                  Previous
                </button>
                <button
